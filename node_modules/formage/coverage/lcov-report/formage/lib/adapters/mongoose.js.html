...
<html lang="en">
<head>
    <title>Code coverage report for formage\lib\adapters\mongoose.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">formage\lib\adapters\mongoose.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90% <small>(117 / 130)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">72.97% <small>(54 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(18 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">91.13% <small>(113 / 124)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">formage\lib\adapters\</a> &#187; mongoose.js</div>
</div>
<div class="body">
...
function path_to_field(path, prefix, path_name, tree) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof(fieldOptions.type) === 'undefined') <span class="cstat-no" title="statement not covered" >return null;</span>
...
&nbsp;
    if (fieldOptions.validate) {
        validators.push(function (value) {
            ...
            return result ? true : <span class="branch-1 cbranch-no" title="branch not covered" >fieldOptions.validate[1];</span>
        });
    }
    if ('min' in fieldOptions) {
        var min = fieldOptions.min;
        validators.push(function (value) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (value &gt;= min) {
                return true;
            }
            else {
<span class="cstat-no" title="statement not covered" >                return 'value must be equal or greater than ' + min;</span>
            }
        });
        options.min = min;
    }
    if ('max' in fieldOptions) {
        ...
        validators.push(function (value) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (value &lt;= max) {
                return true;
            }
            else {
<span class="cstat-no" title="statement not covered" >                return 'value must be equal or lower than ' + max;</span>
            }
        });
        options.max = max;
    }
    if ('step' in fieldOptions) {
        ...
        validators.push(function (value) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (Math.round(value / step) === value / step) {
                return true;
            }
            else {
<span class="cstat-no" title="statement not covered" >                return 'value must be according to step ' + step;</span>
            }
        });
        options.step = step;
    }
    if (Array.isArray(fieldOptions.type)) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isEmpty(schema.paths)) <span class="cstat-no" title="statement not covered" >return null;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if ('formageField' in fieldOptions) {
<span class="cstat-no" title="statement not covered" >        var Field = fieldOptions.formageField;</span>
<span class="cstat-no" title="statement not covered" >        return new Field(options);</span>
    }
&nbsp;
    var fieldName = fieldOptions.type.name + 'Field';
    <span class="missing-if-branch" title="else path not taken" >E</span>if (fieldName in Fields) {
        return new Fields[fieldName](options);
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (path.instance &amp;&amp; path.instance === 'String') {</span>
<span class="cstat-no" title="statement not covered" >        return new Fields.StringField(options);</span>
    }
<span class="cstat-no" title="statement not covered" >    return new Fields.StringField(options);</span>
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(inner_schema)) {
        inner_schema = inner_schema[0];
    } else {
<span class="cstat-no" title="statement not covered" >        if (inner_schema &amp;&amp; inner_schema.type &amp;&amp; Array.isArray(inner_schema.type)) {</span>
<span class="cstat-no" title="statement not covered" >            inner_schema = inner_schema.type[0];</span>
        }
    }
&nbsp;
&nbsp;
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (fieldOptions.type[0].paths &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >fieldOptions.type[0].tree)</span> {
<span class="cstat-no" title="statement not covered" >        schema = fieldOptions.type[0];</span>
    } else {
