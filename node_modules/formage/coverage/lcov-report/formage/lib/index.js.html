...
<html lang="en">
<head>
    <title>Code coverage report for formage\lib\index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">formage\lib\index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">formage\lib\</a> &#187; index.js</div>
</div>
<div class="body">
...
exports.serve_static = _.once(function (app, express, options) {
    ...
    options.root = options.root || <span class="branch-1 cbranch-no" title="branch not covered" >'/admin';</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >        case 'jugglingdb':</span>
<span class="cstat-no" title="statement not covered" >            adapter = require('./adapters/jugglingdb')(jugglingdb);</span>
...
&nbsp;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.no_users) {
        if (options.admin_users_gui) {
            models.Admin_Users = adapter.Users;
        }
        // Some DI magic. Sorry :(
        exports.AdminForm.DI = {getFields: adapter.getFields};
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.dont_ensure_superuser) {
