...
<html lang="en">
<head>
    <title>Code coverage report for formage\example\classic\models\tests.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">formage\example\classic\models\tests.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">formage\example\classic\models\</a> &#187; tests.js</div>
</div>
<div class="body">
...
schema.virtual('swizzle').get(function() {
    return (this.get('string_req') || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.split('').reverse().join('');
});
&nbsp;</pre></td></tr>
</table></pre>
